            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        ...
                        <!-- <img src="http://www.kbrtec.com.br/teste-tarcisio-thallys/n/header-template.png" width="600"> -->
                    </td>
                </tr>
                ...
                <tr>
                    <td bgcolor="#FFFFFF" style="padding: 30px 50px 50px 50px; text-align: center">
                        <font face="Roboto, Arial, Helvetica, sans-serif" weight="700" size="6" color="#7400d4" style="font-weight: 700">Olá! </font>
                    </td>
                </tr>
                <tr>
                    <td style="font-family: Roboto, Arial, Helvetica, sans-serif; font-weight: 600; color: #272933; padding: 0px 50px 50px 50px;">
                        ...
                        {{$data['message']}}
                        <!-- Temos boas notícias! O seu pagamento no valor de
                                <span style="display: inline-block; background: #00cb94; border-radius: 5px; color: #ffffff; padding: 3px;">R$ 99,99</span>
                                foi aprovado e o crédito já foi liberado na sua conta. -->
                        </font>
                    </td>
                    <!-- BOTÃO -->
                <tr>
                    <td style="text-align: center; padding-bottom: 50px;">
                        <a href="#" style="display: inline-block" target="_blank" title="Acessar">
                            <img src="{{url('/images/btn-template.png')}}" width="445">
                            <!-- <img src="http://www.kbrtec.com.br/teste-tarcisio-thallys/n/btn-template.png" width="445"> -->
                        </a>
                    </td>
                </tr>
                </tr>
