...
$sectionSubtitle = "Cadastrar Especialidade";
$defaultPath = "/admin/especialidade/cadastrar";
?>
        ...
        <div class="flex-grid--wrap content__box--first nopadding col-12"> @include('admin.includes.messages')
            <div class="flex-grid--wrap halign-center valign-top col-12 pd-10">
                ...
                <form class="form__maquinas form flex-grid--wrap col-12 pd-10"
                      action="{{ url('admin/especialidade/armazenar') }}" method="POST">
                    @csrf
                    <div class="flex-grid--wrap col-12">
                        ...
                        <input type="text" class="input col-12" name="nm_especialidade" value="" data-validate="empty" data-name="Especialidade" maxlength="100">
